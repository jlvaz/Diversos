...
BEGIN
   ...
   logfilename => '+DATA/dbfeso211g/onlinelog/group_2.286.902058393');

   DBMS_LOGMNR.add_logfile (
   options => DBMS_LOGMNR.addfile,
   logfilename => '+DATA/dbfeso211g/onlinelog/group_3.285.902058421');

   DBMS_LOGMNR.add_logfile (
   options => DBMS_LOGMNR.addfile,
   logfilename => '+DATA/dbfeso211g/onlinelog/group_4.262.902058437');

   DBMS_LOGMNR.add_logfile (
   options => DBMS_LOGMNR.addfile,
   logfilename => '+DATA/dbfeso211g/onlinelog/group_5.284.902058467');

   DBMS_LOGMNR.add_logfile (
   options => DBMS_LOGMNR.addfile,
   logfilename => '+DATA/dbfeso211g/onlinelog/group_6.273.902058491');

...
BEGIN
   DBMS_LOGMNR_D.build (
   dictionary_filename => 'dictdbfeso1.ora',  dictionary_location => '/u01/dict');   
END;
...
BEGIN
   ...
   logfilename => '+DATA1/dbfeso1/onlinelog/group_1.261.923030239');

   DBMS_LOGMNR.add_logfile (
   options => DBMS_LOGMNR.addfile,
   logfilename => '+DATA1/dbfeso1/onlinelog/group_2.256.923030421');

   DBMS_LOGMNR.add_logfile (
   options => DBMS_LOGMNR.addfile,
   logfilename => '+DATA1/dbfeso1/onlinelog/group_3.259.923030331');

   DBMS_LOGMNR.add_logfile (
   options => DBMS_LOGMNR.addfile,
   logfilename => '+DATA1/dbfeso1/onlinelog/group_4.258.923030351');
   
   DBMS_LOGMNR.add_logfile (
   options => DBMS_LOGMNR.addfile,
   logfilename => '+DATA1/dbfeso1/onlinelog/group_5.257.923030367');
